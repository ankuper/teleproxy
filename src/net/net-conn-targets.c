/*
    Connection target management - extracted from net-connections.c.

    Handles connection target lifecycle: create, destroy, reconnect scheduling,
    dead connection cleanup, and hash table lookup.
*/
